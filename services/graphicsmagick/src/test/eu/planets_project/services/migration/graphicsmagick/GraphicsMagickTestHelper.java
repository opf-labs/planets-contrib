 ...
 *
 */
public class GraphicsMagickTestHelper {
	/** output for stand alone tests */
	public static final String STANDALONE_TEST_OUT = "GraphicsMagickMigrate_STANDALONE_TEST";
	/** output for server tests */
	public static final String SERVER_TEST_OUT = "GraphicsMagickMigrate_SERVER_TEST";
	/** output for local tests */
	public static final String LOCAL_TEST_OUT = "GraphicsMagickMigrate_LOCAL_TEST";
...
//	public static final String JP2_TEST_FILE = "tests/test-files/images/bitmap/test_jp2/2274192346_4a0a03c5d6.jp2";
	...
	public static int COMP_QUAL_25 = 25;
	/** compression quality constant */
	public static int COMP_QUAL_50 = 50;
	/** compression quality constant */
	public static int COMP_QUAL_75 = 75;
	/** compression quality constant */
	public static int COMP_QUAL_100 = 100;
