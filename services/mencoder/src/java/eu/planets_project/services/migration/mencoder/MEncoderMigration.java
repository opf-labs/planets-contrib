package eu.planets_project.services.migration.mencoder;
...
public class MEncoderMigration implements Migrate, Serializable {
     ...
     * framework.
     **/
    private static final String SERVICE_CONFIG_FILE_NAME = "mencoderwrapper.xml";

    /** The file name of the dynamic run-time configuration **/
    private static final String RUN_TIME_CONFIGURATION_FILE_NAME = "pserv-pa-mencoder";


    /**
     * The service name.
     */
    static final String NAME = "MEncoderMigration";
    static final String configfile = "mencoderwrapper.xml";
