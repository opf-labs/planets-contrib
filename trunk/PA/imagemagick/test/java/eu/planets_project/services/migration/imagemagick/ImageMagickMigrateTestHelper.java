 ...
 *
 */
public class ImageMagickMigrateTestHelper {
	...
	/** compression quality constant */
	public static String COMP_QUAL_75 = "75";
	/** compression quality constant */
	public static String COMP_QUAL_100 = "100";
	/** compression quality undefined */
	public static String COMP_TYPE_UNDEF = "0";
	/** compression type no */
	public static String COMP_TYPE_NO = "1";
	/** compression type BZIP */
	public static String COMP_TYPE_BZIP = "2";
	/** compression type fax */
	public static String COMP_TYPE_FAX = "3";
	/** compression type group 4 fax */
	public static String COMP_TYPE_GROUP4 = "4";
	/** compression type JPEG */
	public static String COMP_TYPE_JPEG = "5";
	/** compression type JPEG 2000 */
	public static String COMP_TYPE_JPEG2000 = "6";
	/** compression type JPEG lossless */
	public static String COMP_TYPE_JPEG_LOSSLESS = "7";
	/** compression type LZW */
	public static String COMP_TYPE_LZW = "8";
	/** compression type RLE */
	public static String COMP_TYPE_RLE = "9";
	/** compression type zip */
	public static String COMP_TYPE_ZIP = "10";
}
