...
import eu.planets_project.services.migration.openjpeg.OpenJpegMigration;
...
public final class OpenJpegMigrationTest extends TestCase {
    ...
    public void testMigrateAll() throws IOException {
        ...
        // demonstration1.tif, demonstration1.jp2
        for(int i = 1; i < 2; i++)
        {
    ...
    {
        // Test file name
        String inTestFileName = "PA/openjpeg/test/testfiles/demonstration"+String.valueOf(cycle)+"." + origExt.toLowerCase();
        // Output file name
     ...
     */
//    @Test
//    public void testMigrateTIFtoJP2() throws IOException {
//        try {
//            /*
...
//                    .build();
//
//            MigrateResult mr = dom.migrate(input, Format.extensionToURI("tif"), Format.extensionToURI("jp2"), null);
//            assertTrue("Migration result object is null.", mr != null);
//            DigitalObject doOut = mr.getDigitalObject();
//
//            assertTrue("Resulting digital object is null.", doOut != null);
//
//            //String strOutFile = "PA/openjpeg/test/testfiles/testout.jp2";
//            //File file = new File(strOutFile);
//            InputStream is = doOut.getContent().read();
//            //writeByteArrayToFile(doOut.getContent().getValue());
//            String resFileDir = "PA/openjpeg/test/testfiles/";
...
//    }
    ...
    synchronized byte[] readByteArrayFromFile() 
        ...
        String strOutFile = "PA/openjpeg/test/testfiles/testin.tif";
        fTmpOutFile = new File(strOutFile);
        assertTrue("tif input file "+fTmpOutFile.getAbsolutePath()+" does not exist.", fTmpOutFile.exists());
        try {
